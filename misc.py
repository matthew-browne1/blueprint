...
dfs=[]
laydown = pd.read_excel("All_Laydown.xlsx", index_col=0)
dfs.append(laydown)
index = pd.read_excel("All_Index.xlsx", index_col=0)
dfs.append(index)
channel_inputs = pd.read_excel("All_Channel_Inputs.xlsx", index_col=0)
dfs.append(channel_inputs)
incr_rev_st = pd.read_excel("All_Incremental_Revenue_ST.xlsx", index_col=0)
dfs.append(incr_rev_st)
incr_rev_lt = pd.read_excel("All_Incremental_Revenue_LT.xlsx", index_col=0)
...
incr_rev_st.to_sql('All_Incremental_Revenue_ST', engine, if_exists='replace')
incr_rev_lt.to_sql('All_Incremental_Revenue_LT', engine, if_exists='replace')
